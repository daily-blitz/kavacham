          ...
          <footer className="footer">
            <div className="footer-content">
              ...
              <div className="footer-column">
                <h4>Shop</h4>
                <ul>
                  <li><Link to="/collections/phone-skins">Phone Skins</Link></li>
                  <li><Link to="/collections/phone-cases">Phone Cases</Link></li>
                  <li><Link to="/collections/screen-protectors">Screen Protectors</Link></li>
            ...
            <div className="footer-bottom">
              <p>&copy; {new Date().getFullYear()} Kavacham. All rights reserved.</p>
            </div>
          </footer>
        )}
      </Await>
